...
namespace OpenTK.Extension
{
    ...
    partial class Gl
    {
        ...
        public static void GetObjectLabel(OpenTK.Extension.ObjectLabel identifier, UInt32 name, Int32 bifSize, [OutAttribute] Int32[] length, [OutAttribute] System.Text.StringBuilder label)
        {
        ...
        public static IntPtr GetStringi(StringName name, UInt32 index)
        {
        ...
        public static void RenderbufferStorage(OpenTK.Extension.RenderbufferTarget target, RenderbufferStorage internalFormat, Int32 width, Int32 height)
        {
            Delegates.glRenderbufferStorage(target, internalFormat, width, height);
        }

        public static void NamedRenderbufferStorage(UInt32 renderbuffer, OpenTK.Extension.RenderbufferStorage internalFormat, Int32 width, Int32 height)
        {
            Delegates.glNamedRenderbufferStorage(renderbuffer, internalFormat, width, height);
        }

        public static void RenderbufferStorageMultisample(OpenTK.Extension.RenderbufferTarget target, Int32 samples, RenderbufferStorage internalFormat, Int32 width, Int32 height)
        {
