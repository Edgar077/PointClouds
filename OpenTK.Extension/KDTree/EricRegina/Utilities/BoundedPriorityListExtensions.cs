...
namespace OpenTKExtension
{
    ...
    public static class BoundedPriorityListExtensions
    {
        ...
        /// <typeparam name="TDimension">The type of the dimensions of the <see cref="KDTreeEricReginaGeneric{TDimension,TNode}"/></typeparam>
        /// <typeparam name="TNode">The type of the nodes of the <see cref="KDTreeEricReginaGeneric{TDimension,TNode}"/></typeparam>
        /// <returns>The points and nodes in the <see cref="KDTreeEricReginaGeneric{TDimension,TNode}"/> implicitly referenced by the <see cref="BoundedPriorityList{TElement,TPriority}"/>.</returns>
