...
namespace OpenTK.Extension
{
        ...
        where T : struct
    {
        ...
        public VBO(string name, T[] Data, int Length, BufferTarget Target = BufferTarget.ArrayBuffer, BufferUsageHint Hint = BufferUsageHint.StaticDraw)
        {
            Name = name;
        ...
        /// <param name="Target">Specifies the target buffer object.</param>
        /// <param name="Hint">Specifies the expected usage of the data store.</param>
        public VBO(string name, T[] Data, int Position, int Length, BufferTarget Target = BufferTarget.ArrayBuffer, BufferUsageHint Hint = BufferUsageHint.StaticDraw)
        {
            Name = name;
            Length = Math.Max(0, Math.Min(Length, Data.Length));
        ...
        /// <param name="Target">Specifies the target buffer object.</param>
        /// <param name="Hint">Specifies the expected usage of the data store.</param>
        public VBO(string name, T[] Data, BufferTarget Target = BufferTarget.ArrayBuffer, BufferUsageHint Hint = BufferUsageHint.StaticDraw)
        {
            Name = name;
        ...
        /// </summary>
        /// <param name="Data">Specifies a pointer to data that will be copied into the data store for initialization.</param>
        public VBO(string name, T[] Data)
            : this(name, Data, BufferTarget.ArrayBuffer, BufferUsageHint.StaticDraw)
        {
        }
        ...
        {
            if (vboID != 0) 
                System.Diagnostics.Debug.Fail(this.Name + " : VBO was not disposed of properly.");
        }
        #endregion
