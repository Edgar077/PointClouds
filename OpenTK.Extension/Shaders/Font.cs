...
namespace OpenTK
{
    ...
    public class BMFont
    {
        ...
        public BMFont(string descriptorPath, string texturePath)
        {
            ...
            {
                System.Windows.Forms.MessageBox.Show("Error in font using file:  " + descriptorPath);
        ...
        public FontVAO CreateString(ShaderProgram program, string text, Justification justification = Justification.Left)
        {
            ...
            return new FontVAO(program, new VBO<Vector3>("Font vertices", vertices), new VBO<Vector2>("Font UVS", uvs), new VBO<int>("Font indices", indices, BufferTarget.ElementArrayBuffer));
        }
