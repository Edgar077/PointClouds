...
namespace OpenTK.Extension
{
    ...
    partial class Gl
    {
        internal static partial class Delegates
        {
            ...
            internal delegate void ClearNamedFramebufferfi(UInt32 framebuffer, ClearBuffer buffer, Single depth, Int32 stencil);
            ...
            internal delegate void GetObjectLabel(OpenTK.Extension.ObjectLabel identifier, UInt32 name, Int32 bifSize, [OutAttribute] Int32[] length, [OutAttribute] System.Text.StringBuilder label);
            ...
            internal delegate void LogicOp(OpenTK.Extension.LogicOp opcode);
            ...
            internal delegate void ObjectLabel(OpenTK.Extension.ObjectLabel identifier, UInt32 name, Int32 length, String label);
            ...
            internal delegate void PolygonMode(MaterialFace face, OpenTK.Extension.PolygonMode mode);
            ...
            internal delegate void NamedFramebufferReadBuffer(UInt32 framebuffer, BeginMode mode);
            ...
            internal delegate void RenderbufferStorage(OpenTK.Extension.RenderbufferTarget target, OpenTK.Extension.RenderbufferStorage internalFormat, Int32 width, Int32 height);
            internal static RenderbufferStorage glRenderbufferStorage;
            internal delegate void NamedRenderbufferStorage(UInt32 renderbuffer, OpenTK.Extension.RenderbufferStorage internalFormat, Int32 width, Int32 height);
            internal static NamedRenderbufferStorage glNamedRenderbufferStorage;
            internal delegate void RenderbufferStorageMultisample(OpenTK.Extension.RenderbufferTarget target, Int32 samples, OpenTK.Extension.RenderbufferStorage internalFormat, Int32 width, Int32 height);
            internal static RenderbufferStorageMultisample glRenderbufferStorageMultisample;
            internal delegate void NamedRenderbufferStorageMultisample(UInt32 renderbuffer, Int32 samples, OpenTK.Extension.RenderbufferStorage internalFormat, Int32 width, Int32 height);
            ...
            internal delegate void StencilFuncSeparate(OpenTK.Extension.StencilFace face, OpenTK.Extension.StencilFunction func, Int32 @ref, UInt32 mask);
            ...
            internal delegate void StencilMaskSeparate(OpenTK.Extension.StencilFace face, UInt32 mask);
            internal static StencilMaskSeparate glStencilMaskSeparate;
            internal delegate void StencilOp(OpenTK.Extension.StencilOp sfail, OpenTK.Extension.StencilOp dpfail, OpenTK.Extension.StencilOp dppass);
            internal static StencilOp glStencilOp;
            internal delegate void StencilOpSeparate(OpenTK.Extension.StencilFace face, OpenTK.Extension.StencilOp sfail, OpenTK.Extension.StencilOp dpfail, OpenTK.Extension.StencilOp dppass);
            ...
            internal delegate void VertexAttribFormat(UInt32 attribindex, Int32 size, OpenTK.Extension.VertexAttribFormat type, Boolean normalized, UInt32 relativeoffset);
            internal static VertexAttribFormat glVertexAttribFormat;
            internal delegate void VertexAttribIFormat(UInt32 attribindex, Int32 size, OpenTK.Extension.VertexAttribFormat type, UInt32 relativeoffset);
            internal static VertexAttribIFormat glVertexAttribIFormat;
            internal delegate void VertexAttribLFormat(UInt32 attribindex, Int32 size, OpenTK.Extension.VertexAttribFormat type, UInt32 relativeoffset);
            internal static VertexAttribLFormat glVertexAttribLFormat;
            internal delegate void VertexArrayAttribFormat(UInt32 vaobj, UInt32 attribindex, Int32 size, OpenTK.Extension.VertexAttribFormat type, Boolean normalized, UInt32 relativeoffset);
            internal static VertexArrayAttribFormat glVertexArrayAttribFormat;
            internal delegate void VertexArrayAttribIFormat(UInt32 vaobj, UInt32 attribindex, Int32 size, OpenTK.Extension.VertexAttribFormat type, UInt32 relativeoffset);
            internal static VertexArrayAttribIFormat glVertexArrayAttribIFormat;
            internal delegate void VertexArrayAttribLFormat(UInt32 vaobj, UInt32 attribindex, Int32 size, OpenTK.Extension.VertexAttribFormat type, UInt32 relativeoffset);
