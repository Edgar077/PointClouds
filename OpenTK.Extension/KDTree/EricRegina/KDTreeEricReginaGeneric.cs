...
//https://github.com/MathFerret1013/Supercluster.KDTree
...
namespace OpenTKExtension
{
    ...
    [Serializable]
    public class KDTreeEricReginaGeneric<TDimension, TNode>
        where TDimension : IComparable<TDimension>
    {
        ...
        /// </summary>
        public Func<TDimension[], TDimension[], float> Metric { get; set; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="KDTreeEricReginaGeneric{TDimension,TNode}"/> class.
        /// </summary>
        /// <param name="dimensions">The number of dimensions in the data set.</param>
        /// <param name="points">The points to be constructed into a <see cref="KDTreeEricReginaGeneric{TDimension,TNode}"/></param>
        ...
        public KDTreeEricReginaGeneric(
            int dimensions,
            TDimension[][] points,
            Func<TDimension[], TDimension[], float> metric,
            ...
            IReadOnlyCollection<TDimension[]> points)
        {
            ...
            Array.Copy(sortedPoints.Select(z => z).ToArray(), leftPoints, leftPoints.Length);
            ...
            Array.Copy(
                sortedPoints.Select(z => z).ToArray(),
                medianPointIdx + 1,
                rightPoints,
                0,
                rightPoints.Length);
