...
//            return new FontVAO(program, new VBO<Vector3>("Cube vertices", vertices), new VBO<Vector2>("Cube uvs", uvs), new VBO<int>("Cube indices", indices, BufferTarget.ElementArrayBuffer));
//        }
